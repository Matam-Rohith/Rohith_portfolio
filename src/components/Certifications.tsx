...
const certs: Cert[] = [
  // Cloud — indigo/sky instead of amber
  { title: 'AWS Cloud Architecting',             issuer: 'AWS Academy',         date: 'Feb 2024', link: 'https://www.credly.com/badges/aa016e5d-000f-44ad-9868-2aaea878f756/public_url', icon: '☁️', color: 'sky',    category: 'Cloud', highlight: true },
  { title: 'AWS Cloud Data Pipeline Builder',    issuer: 'AWS Academy',         date: 'Feb 2024', link: 'https://www.credly.com/badges/8e430a47-e5c8-4d2a-bfb6-cbbe1d203d1d/public_url', icon: '☁️', color: 'sky',    category: 'Cloud' },
  { title: 'AWS Cloud Foundations',              issuer: 'AWS Academy',         date: 'Feb 2024', link: 'https://www.credly.com/badges/f7da821b-4136-4bed-82cf-c2e99d0cbb87/public_url', icon: '☁️', color: 'sky',    category: 'Cloud' },
  { title: 'AWS Cloud Web Application Builder',  issuer: 'AWS Academy',         date: 'Feb 2024', link: 'https://www.credly.com/badges/757c26cb-57c8-41c4-8dbb-ebbe3ed461a2/public_url', icon: '☁️', color: 'sky',    category: 'Cloud' },
  { title: 'AWS Machine Learning Foundations',   issuer: 'AWS Academy',         date: 'Feb 2024', link: 'https://www.credly.com/badges/ff75ac2a-f35f-415e-b823-50b81dbd37bd/public_url', icon: '🤖', color: 'indigo', category: 'Cloud' },
  ...
  { title: 'Introduction to Cloud Computing',    issuer: 'Coursera',            date: '',         link: 'https://coursera.org/share/a620972885e5b78e0db03796a0635f26',                    icon: '☁️', color: 'sky',    category: 'Cloud' },
  { title: 'Creating Azure Serverless Functions',issuer: 'Coursera / Microsoft',date: '',         link: 'https://coursera.org/share/52239fe8c1b3047cef9c96412e90dfdb',                    icon: '⚡', color: 'indigo', category: 'Cloud' },
  ...
  { title: 'Introduction to Databases',        issuer: 'Coursera',         date: '',         link: 'https://coursera.org/share/6b59d66e7da4af7ce75eedc302c976d1',                   icon: '🗄️', color: 'indigo', category: 'Data' },
  ...
  // Dev
  { title: 'Data Structures & Algorithms (C++)',    issuer: 'IBM (edX)',         date: 'Oct 2023', link: 'https://courses.edx.org/certificates/5bf5f3f6c8454add9976b0c86e88b09b',          icon: '⚙️', color: 'indigo', category: 'Dev', highlight: true },
  ...
  { title: 'Introduction to Git and GitHub',        issuer: 'Coursera',          date: '',         link: 'https://coursera.org/share/1a71c18ea7a4771a00378105aa90a8dc',                   icon: '🐙', color: 'slate',  category: 'Dev' },
  { title: 'Version Control with Git',              issuer: 'Coursera',          date: '',         link: 'https://coursera.org/share/95914b39516c89fe6a44113c6a985476',                   icon: '🐙', color: 'slate',  category: 'Dev' },
  // Systems
  { title: 'Introduction to OS Specialization',     issuer: 'Coursera', date: '', link: 'https://coursera.org/share/3fd36755bc852a8ffc975f25cf9375ab', icon: '🖥️', color: 'purple', category: 'Systems', highlight: true },
  ...
  { title: 'Intro to Computers, OS & Security',      issuer: 'Coursera', date: '', link: 'https://coursera.org/share/9ebc612d9f04d13a6e969da36d58b528', icon: '🔐', color: 'slate',  category: 'Systems' },
  { title: 'Introduction to Microprocessors',        issuer: 'ArmEducationX (edX)', date: 'Oct 2023', link: 'https://courses.edx.org/certificates/e4eede1dbb064fc1a7a2784fff0f0d70', icon: '🔌', color: 'slate', category: 'Systems' },
  // Management
  { title: 'Foundations of Project Management', issuer: 'Coursera / Google', date: '', link: 'https://coursera.org/share/ab40d22bcb21288116b61c6c657845b2', icon: '📋', color: 'indigo', category: 'Management' },
];

const categories = ['All', 'Cloud', 'Networking', 'Data', 'Dev', 'Systems', 'Management'];

// NO amber/orange/yellow in this map
const colorMap: Record<string, { card: string; pill: string; badge: string; icon: string }> = {
  sky:    { card: 'border-sky-200/60 dark:border-sky-400/15',       pill: 'bg-sky-100 text-sky-800 dark:bg-sky-900/40 dark:text-sky-300',         badge: 'from-sky-500 to-cyan-500',     icon: 'text-sky-600 dark:text-sky-400' },
  indigo: { card: 'border-indigo-200/60 dark:border-indigo-400/15', pill: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/40 dark:text-indigo-300', badge: 'from-indigo-500 to-blue-500', icon: 'text-indigo-600 dark:text-indigo-400' },
  blue:   { card: 'border-blue-200/60 dark:border-blue-400/15',     pill: 'bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300',     badge: 'from-blue-500 to-indigo-500',  icon: 'text-blue-600 dark:text-blue-400' },
  ...
  violet: { card: 'border-violet-200/60 dark:border-violet-400/15', pill: 'bg-violet-100 text-violet-800 dark:bg-violet-900/40 dark:text-violet-300', badge: 'from-violet-500 to-indigo-500', icon: 'text-violet-600 dark:text-violet-400' },
  purple: { card: 'border-purple-200/60 dark:border-purple-400/15', pill: 'bg-purple-100 text-purple-800 dark:bg-purple-900/40 dark:text-purple-300', badge: 'from-purple-500 to-violet-500', icon: 'text-purple-600 dark:text-purple-400' },
  green:  { card: 'border-green-200/60 dark:border-green-400/15',   pill: 'bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300', badge: 'from-green-500 to-teal-500',   icon: 'text-green-600 dark:text-green-400' },
  slate:  { card: 'border-slate-200/60 dark:border-slate-400/15',   pill: 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300',   badge: 'from-slate-500 to-indigo-500', icon: 'text-slate-600 dark:text-slate-400' },
};
